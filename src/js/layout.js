  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
      ...
      <div>
        ...
        <ul class="space-y-2 text-xs text-slate-600 dark:text-slate-400">
          <li><a href="/blog.html" class="hover:text-blue-600 dark:hover:text-blue-400">Articles & Guides</a></li>
          <li><a href="/blog-article-1.html" class="hover:text-blue-600 dark:hover:text-blue-400">Margin vs Markup Guide</a></li>
          <li><a href="/blog-article-2.html" class="hover:text-blue-600 dark:hover:text-blue-400">Break-Even Analysis Guide</a></li>
          <li><a href="/blog-article-3.html" class="hover:text-blue-600 dark:hover:text-blue-400">eBay Profit Margin Guide</a></li>
        </ul>
      </div>
